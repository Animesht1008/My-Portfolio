...
const Contact = () => {
  ...
  // Handle form submission logic — opens a prefilled mailto since this is a static site with no backend
  const handleSubmit = (e) => {
    ...
    window.location.href = `mailto:animeshtiwari1875@gmail.com?subject=${subject}&body=${body}`;
      ...
      <div className="relative z-10 w-full flex justify-end items-end">
        ...
        >
          ...
          <div className="flex items-center justify-between mb-12 md:mb-16">
            ...
            <a
              href="mailto:animeshtiwari1875@gmail.com"
              className="text-xs font-mono text-white/50 hover:text-red-500 transition-colors tracking-wider hidden md:block"
            >
              animeshtiwari1875@gmail.com &bull; +91 96914 33656
            </a>
          </div>
